...
var (
	...
	EntitiesColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "name", Type: field.TypeString, Size: 255},
		{Name: "description", Type: field.TypeString, Nullable: true, Size: 10000},
		...
		{Name: "floor_plan_path", Type: field.TypeString, Nullable: true, Size: 1000},
		{Name: "floor_plan_mime_type", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "floor_plan_x", Type: field.TypeFloat64, Nullable: true, Default: 0},
		{Name: "floor_plan_y", Type: field.TypeFloat64, Nullable: true, Default: 0},
	...
	EntityFieldsColumns = []*schema.Column{
		...
		{Name: "text_value", Type: field.TypeString, Nullable: true, Size: 5000},
