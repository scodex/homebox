...
func (_c *EntityCreate) SetNillableQuantity(v *float64) *EntityCreate {
	if v != nil {
		_c.SetQuantity(*v)
	}
	return _c
...
func (_c *EntityCreate) SetSyncChildEntityLocations(v bool) *EntityCreate {
...
func (_c *EntityCreate) SetNillableSyncChildEntityLocations(v *bool) *EntityCreate {
	if v != nil {
		_c.SetSyncChildEntityLocations(*v)
	}
	return _c
}
...
func (_c *EntityCreate) AddTagIDs(ids ...uuid.UUID) *EntityCreate {
	_c.mutation.AddTagIDs(ids...)
	return _c
}

// AddTag adds the "tag" edges to the Tag entity.
func (_c *EntityCreate) AddTag(v ...*Tag) *EntityCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *EntityCreate) SetEntityTypeID(id uuid.UUID) *EntityCreate {
	_c.mutation.SetEntityTypeID(id)
	return _c
}
...
func (_c *EntityCreate) check() error {
	...
	if len(_c.mutation.EntityTypeIDs()) == 0 {
		return &ValidationError{Name: "entity_type", err: errors.New(`ent: missing required edge "Entity.entity_type"`)}
	}
	return nil
}
